...
const createFormSchema = (isAutoUpdate: boolean) =>
  z.object({
...
export type AppReleaseSheetProps = EditReleaseSheetProps;
...
const mapReleaseToFormValues = (release: any) => {
  ...
  const sAssignments =
    release.staticAssignments || release.computer_group_releases || [];
  const dAssignments =
    release.dynamicAssignments || release.dynamic_group_releases || [];
  ...
  const staticInstall = sAssignments
    ...
    .map((r: any) => ({
      groupId:
        r.group_id ||
        (Array.isArray(r.computer_groups)
          ? r.computer_groups[0]?.id
          : r.computer_groups?.id) ||
        "",
  ...
  const dynamicInstall = dAssignments
    ...
    .map((r: any) => ({
      groupId:
        r.group_id ||
        (Array.isArray(r.dynamic_computer_groups)
          ? r.dynamic_computer_groups[0]?.id
          : r.dynamic_computer_groups?.id) ||
        "",
...
export function AppReleaseSheet({
  appId,
  isAutoUpdate = false,
  release,
  open,
  ...
  const [editingDetectionIndex, setEditingDetectionIndex] = useState<
    number | null
  >(null);
        ...
        <SheetHeader className="px-6 pt-6 pb-4 shrink-0">
          ...
          <SheetDescription>
            {isEdit
              ...
              : "Add a new release to this application."}
          </SheetDescription>
        </SheetHeader>
        <Form {...form}>
          <form
            ...
            >
              <div className="px-6 pb-4 shrink-0 bg-background z-10 border-b">
                <TabsList
                  className={cn(
                    "grid w-full",
                    watchedType === "winget" ? "grid-cols-3" : "grid-cols-4",
                  )}
                >
                ...
                <div className="h-full overflow-y-auto px-6 py-6 pb-12">
                  <TabsContent value="details" className="space-y-4 m-0">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem
                          className={cn({ hidden: watchedType !== "winget" })}
                        >
                              ...
                              {field.value && (
                                <Button
                                  ...
                                  onClick={() => {
                                    ...
                                    toast.success(
                                      "Pre-Install script removed from form. Save changes to persist.",
                                    );
                                  }}
                                >
                              ...
                              {field.value && (
                                <Button
                                  ...
                                  onClick={() => {
                                    field.onChange(undefined);
                                    toast.success(
                                      "Post-Install script removed from form. Save changes to persist.",
                                    );
                                  }}
                                >
                                  <Trash2 className="h-4 w-4 mr-1" />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem
                          className={cn({ hidden: watchedType !== "win32" })}
                        >
                                ...
                                try {
                                  ...
                                  const message =
                                    err instanceof Error
                                      ...
                                      : "Unknown error";
                                  toast.error(
                                    `Failed to upload installer: ${message}`,
                                  );
                                  console.error(err);
                                } finally {
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        ...
                        >
                          ...
                          <FormControl>
                            <Input
                              placeholder="msiexec /i app.msi /qn"
                              {...field}
                            />
                          </FormControl>
                          <FormDescription>
                            ...
                            {field.value && (
                              <Button
                                ...
                                onClick={() => {
                                  field.onChange(undefined);
                                  toast.success(
                                    "Requirement script removed from form. Save changes to persist.",
                                  );
                                }}
                              >
                                <Trash2 className="h-4 w-4 mr-1" />
                                ...
                                try {
                                  ...
                                  const message =
                                    err instanceof Error
                                      ...
                                      : "Unknown error";
                                  toast.error(
                                    `Failed to upload requirement script: ${message}`,
                                  );
                                  console.error(err);
                                } finally {
                                ...
                                <FormItem className="flex-1">
                                  <Select
                                    onValueChange={(val) => {
                                      ...
                                      if (g) {
                                        form.setValue(
                                          `assignments.installGroups.${index}.groupType`,
                                          g.type,
                                        );
                                      }
                                    }}
                                ...
                                <FormItem className="flex-1">
                                  <Select
                                    onValueChange={(val) => {
                                      ...
                                      if (g) {
                                        form.setValue(
                                          `assignments.uninstallGroups.${index}.groupType`,
                                          g.type,
                                        );
                                      }
                                    }}
                    ...
                    <Select
                      onValueChange={(val) => {
                        ...
                        if (val === "registry") {
                          popupForm.setValue(
                            "path",
                            popupForm.getValues("registryKey") || "",
                          );
                        } else {
                          popupForm.setValue(
                            "registryKey",
                            popupForm.getValues("path") || "",
                          );
                        }
                      }}
                      value={field.value}
