...
import (
	...
	"github.com/fleetctrl/fleetctrl-hub/api/internal/models"
...
func IsComputerRegistered(sb *supabase.Client) http.HandlerFunc {
...
func RegisterComputer(sb *supabase.Client) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		key := r.PathValue("key")
...
func RustDeskSync(sb *supabase.Client) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		key := r.PathValue("key")
